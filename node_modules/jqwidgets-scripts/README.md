...
About the **jqwidgets-scripts** package
---------

The **jqwidgets-scripts** package contains only the jQWidgets scripts and styles. The [jqwidgets-framework](https://www.npmjs.com/package/jqwidgets-framework) package contains all these plus demos and documentation.
